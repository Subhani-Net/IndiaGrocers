...
const Thumbnail: React.FC<ThumbnailProps> = ({
  ...
  const initialImage = getImageUrl(thumbnail || images?.[0]?.url)
  ...
  return (
    <Container
      className={clx(
        ...
        className,
        {
          "aspect-[11/14] p-4": isFeatured,
          "aspect-[1/1] p-2": !isFeatured && size !== "square",
          "aspect-[1/1] p-0": size === "square",
          "w-full": size === "small" || size === "full",
        }
      )}
      data-testid={dataTestid}
    >
